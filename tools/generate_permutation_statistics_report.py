            ...
            for cluster in clusters:
                ...
                if cluster.get('cluster_number', 0) == 1 and metrics:  # Largest cluster
                    cluster_record.update({
                        ...
                        'largest_cluster_avg_edges_per_gene': cluster.get('avg_edges_per_gene', cluster.get('density', 0)),
                    ...
                    cluster_record.update({
                        ...
                        'largest_cluster_avg_edges_per_gene': None,
...
def main():
    ...
    output_dir = PROJECT_ROOT / "sandbox" / "permutation_statistics"
